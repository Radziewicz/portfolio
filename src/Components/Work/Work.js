        ...
        <div className="wrapper_work">
          <Slide bottom><div className="content">
            ...
            <div className="project_des">
              <p>Do zbudowania mojego pierwszego komercyjnego zlecenia wykorzystałem <span>flexbox</span>'a. Klasy nazywałem według metodologii <span>BEM</span>. Przy stylowaniu wykorzystałem preprocesor <span>SASS</span>. Aby "ożywić"" stronę zastosowałem skrypty z <span>jquery</span>.</p>
              <div className="gap">
          ...
          <Slide bottom><div className="content">
            ...
            <div className="project_des">
              <p>Swoje portfolio zbudowałem na bazie <span>create react app</span>, aby przy okazji pisania móc jednocześnie uczyć się reacta. Przy tworzeniu strony wykorzystałem <span>CSS Grid</span>. Pisząc kod od razu wykorzystywałem standard java script <span>ES5</span>.</p>
                <div className="gap">
